...
export class Constants {
  ...
  public static readonly applicationVersion: string =
    require("../../../package.json").version;
  public static readonly applicationCopyright: string =
    "Copyright Digimezzo Ⓒ 2017 - 2021";
  public static readonly donateUrl: string =
  ...
  public static readonly audioBitrates: number[] = [
    32, 48, 56, 64, 96, 128, 160, 192, 224, 256, 320,
  ];
  ...
  public static readonly externalComponents: any[] = [
    ...
    },
    {
      ...
      licenseUrl:
        "https://github.com/fluent-ffmpeg/node-fluent-ffmpeg/blob/master/LICENSE",
    },
    {
      name: "fs-extra",
      description:
    ...
    },
    {
      ...
      licenseUrl:
        "https://github.com/freeall/progress-stream/blob/master/LICENSE",
    },
    {
